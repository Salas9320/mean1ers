...
angular.module('controlCajaApp').controller('controlCajaCtrl',['movimientosFactory','maestrosFactory', 'controlCajaCtrl']);
...
(function(){
	...
	angular.module('controlCajaApp')
	.factory('maestrosFactory', ['$http',maestrosFactory]);
...
(function(){
	...
	angular.module('controlCajaApp')
	.factory('movimientosFactory',
		['$http', movimientosFactory]);
